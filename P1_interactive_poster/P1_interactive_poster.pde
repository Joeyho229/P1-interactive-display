...
String str35G = "Hurtigere Internet - Omkring 65 gange hurtigere end det du oplever med 4G. Utrolig Lav Latenstid - Tiden tager det tager for 2 enheder at kommunikere med hinanden - Med 5G latensen kan det nå helt ned på 1 millisekund fremfor 70 millisekunder med 4G. Forøget Stråling fra nye 5G Antenner - Strålingsniveauet forbliver langt under grænseværdien.";
...
void draw() {  
  ...
  //textSize(30);
  fill(0);
  text(str45Gcon, width/2+300, height-2850+screenY, 300, height-2600+screenY);
  ...
  text(str35G, width/2+100, height-500+screenY, 300, height-300+screenY);
  //textSize(45);
  fill(255);
